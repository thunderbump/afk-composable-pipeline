...
""",
            ...
            self.assertEqual(
                ...
                "remote and local heads descend from the checkout start commit",
            )
            self.assertEqual(remote_commit, replacement_commit)
...
""",
            ...
            self.assertEqual(result["status"], "failed-needs-human")
            self.assertIn("does not descend from the checkout start commit", result["reason"])
            ...
            self.assertEqual(
                result["git_push"]["retry_reason"],
                "remote review branch does not descend from the checkout start commit",
            )
