...
from afk.review_cycles import (
    ...
    normalize_review_cycles as shared_normalize_review_cycles,
...
from afk.schema_helpers import copy_selected_work_items, validation_artifact_ref
...
def snapshot_work_selection(selected_work: Any) -> list[dict[str, Any]]:
    return copy_selected_work_items(selected_work)
    ...
    for index, validation in enumerate(state["validations"]):
        ...
        refs.append(
            validation_artifact_ref(
                index=index,
                name=string_field(validation_info, "requested_profile"),
...
def normalize_review_cycles(review_cycles: Any) -> list[dict[str, Any]]:
    try:
        return shared_normalize_review_cycles(review_cycles)
